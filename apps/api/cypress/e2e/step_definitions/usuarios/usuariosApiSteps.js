...
When('solicito a atualizacao do usuario pelo ID', () => {
  UsuariosApi.atualizarUsuario(token, usuarioId, dadosAtualizados).then((respostaRecebida) => {
    response = respostaRecebida
  })
})
...
When('solicito a inativacao do usuario pelo ID', () => {
  UsuariosApi.alterarStatusUsuario(token, usuarioId, false).then((respostaRecebida) => {
    response = respostaRecebida
  })
})
...
When('solicito a ativacao do usuario pelo ID', () => {
  UsuariosApi.alterarStatusUsuario(token, usuarioId, true).then((respostaRecebida) => {
